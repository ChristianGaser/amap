...
void subsample_uint8_offset(unsigned char *in, float *out, int dim_in[3], int dim_out[3], int offset_in, int offset_out)
{
  int i, x, y, z;
...
void WarpPriors(unsigned char *prob, unsigned char *priors, unsigned char *mask, float *flow, int *dims, int loop, int samp)
{
  ...
  subsample_uint8_offset(mask, mask_samp, dims, dims_samp, 0, 0);    
  subsample_uint8_offset(priors, f, dims, dims_samp, 0, 0);    
  subsample_uint8_offset(priors, f, dims, dims_samp, vol, vol_samp);    
  subsample_uint8_offset(priors, f, dims, dims_samp, vol2, vol_samp2);    

  /* subsample probabilities and reorder from CSF/GM/WM to GM/WM/CSF */
  subsample_uint8_offset(prob, g, dims, dims_samp, vol, 0);    
  subsample_uint8_offset(prob, g, dims, dims_samp, vol2, vol_samp);    
  subsample_uint8_offset(prob, g, dims, dims_samp, 0, vol_samp2);    
  ...
  subsample_float_offset(mask_samp2, mask_float, dims_samp, dims, 0, 0);    
  ...
  subsample_float_offset(g, priors_float, dims_samp, dims, 0, 0);    
  subsample_float_offset(g, priors_float, dims_samp, dims, vol_samp, vol);    
  subsample_float_offset(g, priors_float, dims_samp, dims, vol_samp2, vol2);    
  for (i = 0; i < vol; i++)
    for (j = 0; j < 3; j++)
